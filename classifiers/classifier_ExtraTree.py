...
class ExtraTree():
    ...
    def train_classifier(self):
        ...
        print ("Fitting data ...")
        clf = ExtraTreesClassifier(n_estimators=_n_estimators, criterion=_criterion, max_depth=_max_depth, min_samples_split=_min_samples_split).fit(x_train, y_train)
