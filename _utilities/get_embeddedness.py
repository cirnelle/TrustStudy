...
path_to_filtered_nodes = '../output/network/nodes/nodes_filtered.csv'
path_to_following_list_folder = '../output/network/following/following_list_'
path_to_combined_mention_edges = '../output/network/edges/edges_ALL_mentions.csv'
path_to_trust_links_file = '../output/trust_links/by_trust_dictionary/strict/trust_links_space.csv'

path_to_store_following_graph = '../output/graph_files/following_intra_group.gexf' #includes intra-public and intra-scientist group following!
path_to_store_combined_mention_and_following_graph = '../output/graph_files/ALL_mentions_following_intra_group.gexf'

path_to_store_following_edges = '../output/network/edges/edges_following_intra_group.csv' #includes intra-public and intra-scientist group following!
path_to_store_combined_mentions_and_following_edges = '../output/network/edges/edges_ALL_mentions_following_intra_group.csv'

path_to_store_embeddedness = '../output/network/embeddedness/by_trust_dictionary/strict/embeddedness_count.csv'
path_to_store_embeddeded_node_list = '../output/network/embeddedness/by_trust_dictionary/strict/embeddedness_node_list.csv'
